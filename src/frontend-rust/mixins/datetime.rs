// checklist translated from datetime.js
...
impl Default for DatetimeComponent {
    fn default() -> Self {
        ...
        Self { source_path:"datetime.js", title:"日期時間 Mixin".to_string(), route:"/mixin/datetime".to_string(), loading:false, dirty:false, error:None, fields:default_fields(), actions:default_actions(), emitted:Vec::new() }
    }
}

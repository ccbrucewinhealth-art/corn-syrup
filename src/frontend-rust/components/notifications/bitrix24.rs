// checklist translated from Bitrix24.vue
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct Bitrix24Component { pub source_path:&'static str, pub provider:String, pub title:String, pub fields:Vec<NotificationField>, pub errors:Vec<String> }

impl Default for Bitrix24Component {
    fn default()->Self {
        logging::debug("notification-ui.bitrix24","default","init provider-specific notification form");
        Self{source_path:"Bitrix24.vue",provider:"bitrix24".to_string(),title:"Bitrix24".to_string(),fields:default_fields(),errors:Vec::new()}
    }
}

impl Bitrix24Component {
    pub fn validate(&self)->Result<(),String>{
        logging::debug("notification-ui.bitrix24","validate",format!("fields={}",self.fields.len()));
    ...
    pub fn set_field(&mut self,name:&str,value:impl Into<String>)->Result<(),String>{
        logging::debug("notification-ui.bitrix24","set_field",name);
    ...
    pub fn build_payload(&self)->Result<NotificationPayload,String>{
        logging::debug("notification-ui.bitrix24","build_payload","compose provider config payload"); self.validate()?;
    ...
    pub fn render_model(&self)->Vec<(String,String)>{
        logging::debug("notification-ui.bitrix24","render_model","render notification form with masked secrets");
...
pub fn default_fields()->Vec<NotificationField>{
    logging::debug("notification-ui.bitrix24","default_fields","build provider-specific fields");
    vec![
...
pub fn render_model(component:&Bitrix24Component)->Vec<(String,String)>{ logging::debug("notification-ui.bitrix24","render_model_compat","compat render"); component.render_model() }

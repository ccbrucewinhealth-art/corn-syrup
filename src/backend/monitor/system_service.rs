...
// checklist No.49 translated from server/monitor-types/system-service.js
// 轉譯分析：系統服務監控，依來源查詢服務 active/running 狀態。
...
#[derive(Debug, Clone)]
pub struct SystemServiceContext {
...
#[derive(Debug, Clone)]
pub struct SystemServiceResult {
    pub state: MonitorState,
    pub message: String,
    pub ping_ms: Option<u128>,
}

impl Default for SystemServiceContext {
    fn default() -> Self {
        Self {
            source_path: "server/monitor-types/system-service.js",
...
impl SystemServiceContext {
    pub fn validate(&self) -> Result<(), String> {
        logging::debug("auto.system_service", "validate", "enter");
...
pub fn system_service_run(ctx: &SystemServiceContext) -> Result<SystemServiceResult, String> {
    logging::debug("auto.system_service", "system_service_run", "enter");
    ctx.validate()?;

...
// checklist No.47 translated from server/monitor-types/grpc.js
// 轉譯分析：gRPC 監控，依來源組合 service/method、metadata、body 與狀態碼檢查。
...
impl Default for GrpcContext {
    fn default() -> Self {
        Self {
            source_path: "server/monitor-types/grpc.js",
            name: "grpc".to_string(),
            target: String::new(),
            expected: None,
            observed: None,
...
impl GrpcContext {
    pub fn validate(&self) -> Result<(), String> {
        logging::debug("auto.grpc", "validate", "enter");
...
pub fn grpc_run(ctx: &GrpcContext) -> Result<GrpcResult, String> {
    logging::debug("auto.grpc", "grpc_run", "enter");
    ctx.validate()?;

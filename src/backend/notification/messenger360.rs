// checklist No.223 translated from server/notification-providers/360messenger.js
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct Messenger360Notification {
...
impl Messenger360Notification {
    pub const SOURCE_PATH: &'static str = "server/notification-providers/360messenger.js";
    pub const PROVIDER: &'static str = "messenger360";

    pub fn new(endpoint: Option<String>, token: Option<String>) -> Self {
        logging::debug("notification.messenger360", "new", "create provider configuration");
    ...
    pub fn validate(&self, message: &NotificationMessage) -> Result<(), String> {
        logging::debug("notification.messenger360", "validate", format!("title_len={}, body_len={}", message.title.len(), message.body.len()));
    ...
    pub fn normalized_endpoint(&self) -> String {
        logging::debug("notification.messenger360", "normalized_endpoint", "resolve endpoint fallback");
    ...
    pub fn build_fields(&self, message: &NotificationMessage) -> Vec<(String, String)> {
        ...
        logging::debug("notification.messenger360", "build_fields", "compose title/body/status/monitor fields");
    ...
    pub fn build_payload(&self, message: &NotificationMessage) -> Result<NotificationPayload, String> {
        ...
        logging::debug("notification.messenger360", "build_payload", "build HTTP request payload");
    ...
    pub fn send_plan(&self, message: &NotificationMessage) -> Result<Vec<(String, String)>, String> {
        logging::debug("notification.messenger360", "send_plan", "convert payload to adapter-neutral plan");
...
pub fn messenger360_run(provider: &Messenger360Notification, message: &NotificationMessage) -> Result<NotificationPayload, String> {
    logging::debug("notification.messenger360", "run", "validate and build provider payload");

...
(async () => {
    try {
        ...
        await ssh.connect({
            host: process.env.CORN_SYRUP_BACKEND_DEMO_HOST,
            port: process.env.CORN_SYRUP_BACKEND_DEMO_PORT,
            username: process.env.CORN_SYRUP_BACKEND_DEMO_USERNAME,
            privateKeyPath: process.env.CORN_SYRUP_BACKEND_DEMO_PRIVATE_KEY_PATH,
        });

        let cwd = process.env.CORN_SYRUP_BACKEND_DEMO_CWD;
        let result;
